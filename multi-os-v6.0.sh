...
show_menu() {
    ...
    echo -e "${YELLOW}[3] ${GREEN}Burpsuite-Pro-(latest)${RESET}"
    echo -e "${YELLOW}[4] ${GREEN}Burpsuite-Pro-(stable)${RESET}"
    echo -e "${YELLOW}[5] ${GREEN}Oh-My-Zsh & Plugins${RESET}"
    echo -e "${YELLOW}[6] ${GREEN}Fish-shell & fisher${RESET}"
    echo -e "${YELLOW}[7] ${GREEN}Kitty-terminal & configuration${RESET}"
    echo -e "${YELLOW}[8] ${GREEN}Ulauncher & Catppuccin Theme${RESET}"
